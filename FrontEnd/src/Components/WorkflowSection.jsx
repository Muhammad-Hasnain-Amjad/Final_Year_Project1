...
function WorkflowSection() {
  return (
    <div className="bg-black text-white px-6 py-20 mt-10">
      ...
      {/* ================= TITLE ================= */}
      <motion.div className="text-center max-w-3xl mx-auto mb-16" {...scrollAnim(0)}>
      ...
      <div className="relative max-w-6xl mx-auto">
        ...
        <div className="grid md:grid-cols-3 gap-12 text-center relative">
          ...
          <motion.div className="flex flex-col items-center" {...scrollAnim(0.2)} whileHover={{ scale: 1.05 }}>
          ...
          <motion.div className="flex flex-col items-center" {...scrollAnim(0.4)} whileHover={{ scale: 1.05 }}>
            <div className="w-16 h-16 rounded-full bg-gray-900 border border-yellow-400 flex items-center justify-center mb-4 shadow-[0_0_20px_rgba(250,204,21,0.3)]">
          ...
          <motion.div className="flex flex-col items-center" {...scrollAnim(0.6)} whileHover={{ scale: 1.05 }}>
            <div className="w-16 h-16 rounded-full bg-gray-900 border border-yellow-400 flex items-center justify-center mb-4 shadow-[0_0_20px_rgba(250,204,21,0.3)]">
      ...
      {/* ================= CTA SECTION ================= */}
      <motion.div className="mt-20 flex justify-center" {...scrollAnim(0.8)} whileHover={{ scale: 1.02 }}>
